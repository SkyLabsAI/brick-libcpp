...
Section with_cpp.
  ...
  cpp.spec "any_none_of_complement_crosscheck_results()" default.
  Lemma any_none_of_complement_crosscheck_results_ok :
    verify[test_cpp.source] "any_none_of_complement_crosscheck_results()".
  Proof using MOD.
    verify_spec; go.
    do 2 (iExists 0%Z, (1$c)%cQp, [],
