...
Section with_cpp.
  ...
  cpp.spec "boolean_result_composition_results()" default.
  Lemma boolean_result_composition_results_ok :
    verify[test_cpp.source] "boolean_result_composition_results()".
  Proof using MOD.
    verify_spec; go.
    repeat use_is_nonzero.
  Qed.
