...
Section with_cpp.
  ...
  cpp.spec "one_past_end_empty_range_results()" default.
  Lemma one_past_end_empty_range_results_ok :
    verify[test_cpp.source] "one_past_end_empty_range_results()".
  Proof using MOD.
    verify_spec; go.
    repeat (iExists 0%Z, (1$c)%cQp, [],
